##############################################################################
# pandas_gdelt_mysql_helper.py
# I'm actually spoiled for choice with data options. I've dumped many of the
# lookup and features tables into MySQL so in a sense it's redundant (though
